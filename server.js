...
const {vendors,vendor_register,vendor_list,vendor_update,content_manager,vendor_documents_upload,vendor_documents_get,vendor_document_delete,vendor_status_change,vendor_signup, vendor_otp_verify,vendor_forgot_password} = require("./routes/vendor")
